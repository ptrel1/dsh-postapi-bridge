...
import { DEFAULT_PREFERENCE, THEME_SETTINGS_NAMESPACE } from '@deepseek-ai/dsh-client-ui-theme'
import { ROLE_ADMIN, UsersStore } from './users-store.js'

export const name = 'postapi-bridge'
export const inject = ['webServer', 'agents', 'sessions', 'settings?']
...
function readPreference(ctx) {
  ...
  return pref === 'light' || pref === 'dark' || pref === 'system' ? pref : DEFAULT_PREFERENCE
}
